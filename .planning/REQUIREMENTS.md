...
- [ ] **CATA-01**: 사용자가 4개 업종 카테고리(금융, 마케팅, HR, IT/DevOps)로 템플릿을 브라우징할 수 있다
- [ ] **CATA-02**: 각 카테고리 페이지에서 템플릿 목록을 카드형 레이아웃으로 볼 수 있다
- [ ] **CATA-03**: 템플릿 카드에 이름, 카테고리, 난이도, 무료/프리미엄 배지가 표시된다
